...
#' @param numeric rh Relative humidity in percentage.
#' @return 
#'
#'
#' @author  Istituto di Biometeorologia Firenze Italy  Alfonso Crisci \email{a.crisci@@ibimet.cnr.it}
#' 
#' @references Wet-Bulb Temperature from Relative Humidity and Air Temperature Ronald Stull \url{http://journals.ametsoc.org/doi/pdf/10.1175/JAMC-D-11-0143.1}
